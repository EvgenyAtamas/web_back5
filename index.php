...
if ($_SERVER['REQUEST_METHOD'] == 'GET') {
    ...
    $values['abil_value'] = empty($_COOKIE['abil_value']) ? array() : unserialize($_COOKIE['abil_value'], ["allowed_classes" => false]);
	...
	if (!isset($_POST['superpower'])) {
        ...
        setcookie('abil_value', serialize($_POST['superpower']), time() + 365 * 24 * 60 * 60);
    }
    ...
    $db = new PDO('mysql:host=localhost;dbname=u20301', $user, $pass, array(PDO::ATTR_PERSISTENT => true));
        ...
        if (!empty($_COOKIE[session_name()]) &&
            ...
            $ability_data = array('1' => 'fly', '2' => 'immortality', '3' => 'telepathy', '4' => 'telekinesis', '5' => 'teleportation');
            foreach ($abilities as $ability) {
                $stmt = $db->prepare("INSERT INTO all_abilities(user_id,abil_value) VALUES(:id,:abil)");
                $stmt->execute(array('id' => $user_id, 'abil' => $ability_data[$ability]));
            }
        } else {
